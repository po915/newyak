...
const ProfilePosts = (props) => {
  ...
  useEffect(() => {
    API.graphql(graphqlOperation(queries.articleByOwner, { ownerID: userID })).then(
      (res) => {
        setArticles(res.data.articleByOwner.items)
        setNextToken(res.data.articleByOwner.nextToken)
      }
    )
  }, [])
